...
namespace Grabber.IMDB
{
  ...
  public class IMDB : IEnumerable
  {
    ...
    public bool GetActorDetailsExtended(IMDBUrl url, bool director, out IMDBActor actor)
    {
        actor = new IMDBActor();
        try
        {
    ...
    public bool GetActorDetailsMediaIndex(IMDBUrl url, bool director, out IMDBActor actor)
    {
        actor = new IMDBActor();
        try
        {
            ...
            HTMLParser parser = new HTMLParser(strBody);
            // ToDo: Here Parser for MediaIndex Links to be used later by IMDBfetcher
            string strThumb = string.Empty;
            string value = string.Empty;
            string value2 = string.Empty;
            // Actor name
