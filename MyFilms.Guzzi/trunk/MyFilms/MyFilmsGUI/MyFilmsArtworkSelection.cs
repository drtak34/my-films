...
namespace MyFilmsPlugin.MyFilms.MyFilmsGUI
{
  ...
  /// 
  /// </summary>
  public class MyFilmsArtworkSelection : MediaPortal.Dialogs.GUIDialogWindow
  {
    ...
    public MyFilmsArtworkSelection()
    {
      GetID = ID_MyFilmsArtworkSelection;
    }

    public override int GetID
    {
      get { return ID_MyFilmsArtworkSelection; }
    }
    ...
    {
      return GUILocalizeStrings.Get(ID_MyFilmsArtworkSelection); // return localized string for Module ID
    }
