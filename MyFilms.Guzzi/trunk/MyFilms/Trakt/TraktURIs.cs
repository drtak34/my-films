...
namespace Trakt
{
    ...
    {
      // Replaced api key with Guzzi's Api-Key !
      public const string ScrobbleShow = @"http://api.trakt.tv/show/{0}/489bf9e7ab0aa019e6e2a30cc9dc9a7e1ffdb020";
      public const string ScrobbleMovie = @"http://api.trakt.tv/movie/{0}/489bf9e7ab0aa019e6e2a30cc9dc9a7e1ffdb020";
      public const string UserWatchedEpisodes = @"http://api.trakt.tv/user/watched/episodes.json/489bf9e7ab0aa019e6e2a30cc9dc9a7e1ffdb020/{0}";
      public const string UserWatchedMovies = @"http://api.trakt.tv/user/watched/movies.json/489bf9e7ab0aa019e6e2a30cc9dc9a7e1ffdb020/{0}";
      public const string UserProfile = @"http://api.trakt.tv/user/profile.json/489bf9e7ab0aa019e6e2a30cc9dc9a7e1ffdb020/{0}";
      public const string SeriesOverview = @"http://api.trakt.tv/show/summary.json/489bf9e7ab0aa019e6e2a30cc9dc9a7e1ffdb020/{0}";
      public const string UserLibraryShows = @"http://api.trakt.tv/user/library/shows.json/489bf9e7ab0aa019e6e2a30cc9dc9a7e1ffdb020/{0}";
      public const string UserLibraryMovies = @"http://api.trakt.tv/user/library/movies.json/489bf9e7ab0aa019e6e2a30cc9dc9a7e1ffdb020/{0}";
      public const string SyncEpisodeLibrary = @"http://api.trakt.tv/show/episode/{0}/489bf9e7ab0aa019e6e2a30cc9dc9a7e1ffdb020";
