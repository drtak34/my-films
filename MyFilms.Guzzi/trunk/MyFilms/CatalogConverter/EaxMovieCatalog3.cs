                ...
                foreach (XmlNode nodeDVD in dvdList)
                {
                  ...
                  if (nodeDVD.Attributes["OriginalTitle"] != null &&
                      nodeDVD.Attributes["OriginalTitle"].Value.Length > 0) WriteAntAtribute(destXml, "OriginalTitle", nodeDVD.Attributes["OriginalTitle"].Value);
                           ...
                           nodeDVD.Attributes["TranslatedTitle"].Value.Length > 0) WriteAntAtribute(destXml, "OriginalTitle", nodeDVD.Attributes["TranslatedTitle"].Value);
                  if (nodeDVD.Attributes["TranslatedTitle"] != null &&
                      nodeDVD.Attributes["TranslatedTitle"].Value.Length > 0) WriteAntAtribute(destXml, "TranslatedTitle", nodeDVD.Attributes["TranslatedTitle"].Value);
                  else if (nodeDVD.Attributes["OriginalTitle"] != null &&
                           nodeDVD.Attributes["OriginalTitle"].Value.Length > 0) WriteAntAtribute(destXml, "TranslatedTitle", nodeDVD.Attributes["OriginalTitle"].Value);
                  if (nodeDVD.Attributes["FormattedTitle"] != null &&
                      nodeDVD.Attributes["FormattedTitle"].Value.Length > 0) WriteAntAtribute(destXml, "FormattedTitle", nodeDVD.Attributes["FormattedTitle"].Value);
                  //WriteAntAtribute(destXml, "Notes/File", File);
                  if (nodeDVD.Attributes["User1Seen"] != null)
                    if (nodeDVD.Attributes["User1Seen"].Value == "-1") WriteAntAtribute(destXml, "Checked", "true");
                    else WriteAntAtribute(destXml, "Checked", "false");
                  ...
                  if (nodeDVD.Attributes["Country"] != null)
                    if (nodeDVD.Attributes["Country"].Value.StartsWith("|")) WriteAntAtribute(destXml, "Country", nodeDVD.Attributes["Country"].Value.Substring(1));
                    else WriteAntAtribute(destXml, "Country", nodeDVD.Attributes["Country"].Value);
                  string wRating = "0";
                  ...
                  wrating = (Convert.ToDecimal(wRating, provider))/10;
                    ...
                    //  try
                    //  {
                    //    wrating = Convert.ToDecimal(wRating, ci);
                    //  }
                    //  catch
                    //  {
                    //  }
                    ...
                    //WriteAntAtribute(destXml, "Rating", wrating.ToString("0.0", ci));
                    WriteAntAtribute(destXml, "Rating", string.Format("{0:F1}", wrating).Replace(",", "."));
                    ...
                    if (nodeDVD.SelectSingleNode("Cast") != null)
                        WriteAntAtribute(destXml, "Actors", nodeDVD.SelectSingleNode("Cast").InnerText);
