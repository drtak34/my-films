...
Partial Public Class AntMovieCatalog
    ...
    Partial Public Class MovieDataTable
        ...
        Private columnIMDBrank As Global.System.Data.DataColumn
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public ReadOnly Property IMDBrankColumn() As Global.System.Data.DataColumn
            Get
                Return Me.columnIMDBrank
            End Get
        End Property
        ...
        Public Overloads Function AddMovieRow( _
            ...
            Dim columnValuesArray() As Object = New Object() {Number, Checked, MediaLabel, MediaType, Source, _Date, Borrower, Rating, RatingUser, OriginalTitle, TranslatedTitle, FormattedTitle, Director, Producer, Country, Category, Year, Length, Actors, URL, Description, Comments, VideoFormat, VideoBitrate, AudioFormat, AudioBitrate, Resolution, Framerate, Languages, Subtitles, DateAdded, Size, Disks, Picture, Fanart, Certification, Writer, Watched, DateWatched, IMDB_Id, TMDB_Id, SourceTrailer, TagLine, Tags, Studio, IMDBrank, IsOnline, IsOnlineTrailer, AspectRatio, Nothing, Length_Num}
        ...
        Public Overloads Function AddMovieRow( _
                    ...
                    ByVal IsOnline As String,  _
                    ByVal IsOnlineTrailer As String,  _
                    ByVal AspectRatio As String) As MovieRow
            Dim rowMovieRow As MovieRow = CType(Me.NewRow,MovieRow)
            Dim columnValuesArray() As Object = New Object() {Number, Checked, MediaLabel, MediaType, Source, _Date, Borrower, Rating, RatingUser, OriginalTitle, TranslatedTitle, FormattedTitle, Director, Producer, Country, Category, Year, Length, Actors, URL, Description, Comments, VideoFormat, VideoBitrate, AudioFormat, AudioBitrate, Resolution, Framerate, Languages, Subtitles, Nothing, Size, Disks, Picture, Fanart, Certification, Writer, Watched, DateWatched, IMDB_Id, TMDB_Id, SourceTrailer, TagLine, Tags, Studio, IMDBrank, IsOnline, IsOnlineTrailer, AspectRatio, Nothing, Nothing}
            rowMovieRow.ItemArray = columnValuesArray
            Me.Rows.Add(rowMovieRow)
            Return rowMovieRow
        End Function
        ...
        Friend Sub InitVars()
            ...
            Me.columnIMDBrank = MyBase.Columns("IMDBrank")
        ...
        Private Sub InitClass()
            ...
            Me.columnIMDBrank = New Global.System.Data.DataColumn("IMDBrank", GetType(String), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnIMDBrank)
    ...
    Partial Public Class MovieRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Property IMDBrank() As String
            Get
                Try 
                    Return CType(Me(Me.tableMovie.IMDBrankColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("Der Wert für Spalte IMDBrank in Tabelle Movie ist DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableMovie.IMDBrankColumn) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IsIMDBrankNull() As Boolean
            Return Me.IsNull(Me.tableMovie.IMDBrankColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetIMDBrankNull()
            Me(Me.tableMovie.IMDBrankColumn) = Global.System.Convert.DBNull
        End Sub
