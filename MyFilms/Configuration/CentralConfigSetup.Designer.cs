namespace MyFilmsPlugin.Configuration
{
  partial class CentralConfigSetup
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.groupBoxCentralConfig.TabIndex = 1;
      ...
      this.btnSyncToServer.TabIndex = 0;
      ...
      this.btnSyncFromServer.TabIndex = 1;
      ...
      this.btnResetRemotePath.TabIndex = 5;
      ...
      this.cbSyncFromServerOnStartup.TabIndex = 0;
      ...
      this.btnMyFilmsCentralConfigFile.TabIndex = 4;
      ...
      this.MyFilmsCentralConfigDir.TabIndex = 3;
