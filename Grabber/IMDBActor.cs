...
namespace Grabber
{
  ...
  /// </summary>
  public class MyFilmsIMDBActor
  {
    public class MyFilmsIMDBActorMovie
    {
    ...
    public MyFilmsIMDBActorMovie this[int index]
    {
      get { return (MyFilmsIMDBActorMovie)_movies[index]; }
      set { _movies[index] = value; }
    }

    public void Add(MyFilmsIMDBActorMovie movie)
    {
      _movies.Add(movie);
    }
  }
