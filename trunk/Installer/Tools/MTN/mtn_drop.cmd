...
rem  movie thumbnailer (mtn) usage
...
rem   -D 12 : edge detection; 0:off >0:on; higher detects more; try -D 4 -D 6 or -D 8
...
rem   -X : use full input filename (including suffix) in output filename
...
start "movie thumbnailer" /b /belownormal /wait C:\Program Files (x86)\Team MediaPortal\MediaPortal\MovieThumbnailer\mtn.exe -P -h 0 -c 3 -r 12 -w 1280 -g 1 -j 92 -b 0.8 -D 12 -L 4:2 -k ffffff -f arial.ttf -F 000000:9:arial.ttf:ffffff:000000:7 "%%~F"
