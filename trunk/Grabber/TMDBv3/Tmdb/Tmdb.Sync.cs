...
namespace WatTmdb.V3
{
    public partial class Tmdb
    {
        ...
        /// </summary>
        /// <returns></returns>
        public MovieSearchResults GetLatestMovie()
        {
            //return ProcessRequest<TmdbLatestMovie>(BuildGetLatestMovieRequest());
          return ProcessRequest<MovieSearchResults>(Generator.GetLatestMovies());
        }
        ...
        public MovieSearchResults GetNowPlayingMovies(int page, string language = "")
        {
          ...
          return ProcessRequest<MovieSearchResults>(Generator.GetNowPlayingMovies(page, language));
        }
        ...
        /// <param name="language">optional - ISO 639-1 language code</param>
        /// <returns></returns>
        public MovieSearchResults GetPopularMovies(int page, string language = null)
        {
            //return ProcessRequest<TmdbPopular>(BuildGetPopularMoviesRequest(page, language));
          return ProcessRequest<MovieSearchResults>(Generator.GetPopularMovies(page, language));
        }
        ...
        /// <param name="language">optional - ISO 639-1 language code</param>
        /// <returns></returns>
        public MovieSearchResults GetTopRatedMovies(int page, string language = null)
        {
            //return ProcessRequest<TmdbTopRated>(BuildGetTopRatedMoviesRequest(page, language));
          return ProcessRequest<MovieSearchResults>(Generator.GetTopRatedMovies(page, language));
        }
        ...
        /// <param name="language">optional - ISO 639-1 language code</param>
        /// <returns></returns>
        public MovieSearchResults GetUpcomingMovies(int page, string language = null)
        {
            //return ProcessRequest<TmdbUpcoming>(BuildGetUpcomingMoviesRequest(page, language));
          return ProcessRequest<MovieSearchResults>(Generator.GetUpcomingMovies(page, language));
        }
